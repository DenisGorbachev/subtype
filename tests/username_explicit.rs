...
impl_try_from_ref!(impl TryFrom<&String> for Username, <Not<Empty> as Transform<String>>::Error, new, Clone::clone);
impl_try_from_ref!(impl TryFrom<&str> for Username, <Not<Empty> as Transform<String>>::Error, new);
