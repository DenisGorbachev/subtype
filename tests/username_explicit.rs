...
impl_try_from_ref!(impl TryFrom<&String> for Username, <NonEmpty as Transform<String>>::Error, new, Clone::clone);
impl_try_from_ref!(impl TryFrom<&str> for Username, <NonEmpty as Transform<String>>::Error, new);
